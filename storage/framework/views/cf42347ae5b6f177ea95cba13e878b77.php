    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div style="margin-bottom: 20px;">
                <span class="support-id"><?php echo e($supportId); ?></span>
                <span class="status-badge">Sudah Dibalas</span>
            </div>

            <!-- Greeting -->
            <div class="greeting">
                Halo <strong><?php echo e($messageName); ?></strong>,
                <br><br>
            ...
            <div class="message-info">
                ...
                <div class="message-info-content">
                    <strong>Subjek:</strong> <?php echo e($messageSubject); ?><br>
                    <strong>Tanggal:</strong> <?php echo e($messageCreatedAt->format('d F Y H:i')); ?> WIB
                </div>
            </div>
            ...
            <div class="original-message">
                ...
                <div class="original-message-content"><?php echo e($messageBody); ?></div>
            </div>
            ...
            <div class="reply-section">
                ...
                <div class="reply-content"><?php echo e($reply); ?></div>
            </div>
            ...
            <!-- <div class="button-group">
                <a href="<?php echo e(route('home')); ?>" class="button">Kembali ke Beranda</a>
            </div> -->
        </div>
        ...
        <div class="footer">
            <p>
                ...
                <br><br>
                <a href="<?php echo e(route('contact')); ?>" class="footer-link">Hubungi Kami</a> | 
...
<?php /**PATH C:\Users\PC_\Documents\New folder\project-sekolah\resources\views/emails/reply-message.blade.php ENDPATH**/ ?>