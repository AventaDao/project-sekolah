                    ...
                    <div style="background: white; padding: 35px; border-radius: 15px; box-shadow: 0 10px 40px rgba(0,0,0,0.12);">
                        ...
                        <?php if(session('status')): ?>
                            <div class="alert alert-success d-flex align-items-center" style="background: linear-gradient(135deg, rgba(76, 175, 80, 0.1), rgba(76, 175, 80, 0.05)); border: 1px solid #4caf50; border-radius: 10px;">
                                ...
                                <span style="color: #333;"><?php echo e(session('status')); ?></span>
                            </div>
                        <?php endif; ?>
                        ...
                        <form action="<?php echo e(route('contact.send')); ?>" method="POST">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input name="name" type="text" class="form-control" value="<?php echo e(old('name')); ?>" style="border-radius: 8px; border: 1.5px solid #e0e0e0; padding: 10px 14px; transition: all 0.3s ease;" required>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input name="email" type="email" class="form-control" value="<?php echo e(old('email')); ?>" style="border-radius: 8px; border: 1.5px solid #e0e0e0; padding: 10px 14px; transition: all 0.3s ease;" required>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input name="phone" type="text" class="form-control" value="<?php echo e(old('phone')); ?>" placeholder="Contoh: 081234567890" inputmode="numeric" pattern="[0-9]*" style="border-radius: 8px; border: 1.5px solid #e0e0e0; padding: 10px 14px; transition: all 0.3s ease;">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-12">
                                    ...
                                    <input name="subject" type="text" class="form-control" value="<?php echo e(old('subject')); ?>" style="border-radius: 8px; border: 1.5px solid #e0e0e0; padding: 10px 14px; transition: all 0.3s ease;" required>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="message" class="form-control" rows="5" style="border-radius: 8px; border: 1.5px solid #e0e0e0; padding: 10px 14px; transition: all 0.3s ease; resize: vertical; font-family: inherit;" required><?php echo e(old('message')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-12">
                                    <div class="form-check">
                                        <input name="consent" class="form-check-input" type="checkbox" id="consent" <?php echo e(old('consent') ? 'checked' : ''); ?> required style="width: 18px; height: 18px; cursor: pointer;">
...
<?php /**PATH C:\Users\PC_\Documents\New folder\project-sekolah\resources\views/contact.blade.php ENDPATH**/ ?>