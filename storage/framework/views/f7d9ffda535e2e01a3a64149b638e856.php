...
<li class="pc-item sidebar-menu-item <?php echo e(request()->is('admin/berita*') ? 'active' : ''); ?>">
    <a href="<?php echo e(route('admin.berita.index')); ?>" class="pc-link sidebar-link">
...
<li class="pc-item sidebar-menu-item <?php echo e(request()->is('admin/penduduk*') ? 'active' : ''); ?>">
    <a href="<?php echo e(route('admin.penduduk.index')); ?>" class="pc-link sidebar-link">
        <span class="pc-micon sidebar-icon">
...
<li class="pc-item sidebar-menu-item <?php echo e(request()->is('admin/pengajuan-surat*') ? 'active' : ''); ?>">
    <a href="<?php echo e(route('admin.pengajuan-surat.index')); ?>" class="pc-link sidebar-link">
        <span class="pc-micon sidebar-icon">
...
<li class="pc-item sidebar-menu-item <?php echo e(request()->is('admin/pengaduan*') ? 'active' : ''); ?>">
    <a href="<?php echo e(route('admin.pengaduan.index')); ?>" class="pc-link sidebar-link">
        <span class="pc-micon sidebar-icon">
...
<li class="pc-item sidebar-menu-item <?php echo e(request()->is('admin/messages*') ? 'active' : ''); ?>">
    <a href="<?php echo e(route('admin.messages.index')); ?>" class="pc-link sidebar-link">
        <span class="pc-micon sidebar-icon">
...
<li class="pc-item sidebar-menu-item <?php echo e(request()->is('admin/activities*') ? 'active' : ''); ?>">
    <a href="<?php echo e(route('admin.activities.index')); ?>" class="pc-link sidebar-link">
        <span class="pc-micon sidebar-icon">
...
<?php /**PATH C:\project-sekolah\resources\views/admin/sidebar.blade.php ENDPATH**/ ?>