        ...
        <div class="row mt-4">
            <div class="col-lg-8 offset-lg-2">
                <div id="letterContent"
                    style="background: white; padding: 30px 35px; box-shadow: 0 0 15px rgba(0,0,0,0.1);">

                    <!-- Letter Header with Icon -->
                    <div
                        style="display: flex; align-items: center; justify-content: center; margin-bottom: 15px; border-bottom: 2px solid #333; padding-bottom: 12px;">
                        <!-- Icon -->
                        <div style="flex-shrink: 0; margin-right: 15px;">
                            <img src="<?php echo e(asset('assets/images/my/icon-sda.png')); ?>" alt="Logo Sidoarjo"
                                style="width: 70px; height: 70px; object-fit: contain;" crossorigin="anonymous">
                        </div>
                        <!-- Text -->
                    ...
                    <div style="text-align: center; margin-bottom: 15px;">
                        <h2 style="font-weight: 700; margin: 0 0 3px 0; font-size: 23px; text-decoration: underline;">
                            <?php echo e($pengajuanSurat->jenis_surat); ?></h2>
                    ...
                    <div style="margin-bottom: 12px; line-height: 1.5; font-size: 16px;">
                        ...
                        <div style="margin-bottom: 18px; font-size: 16px;">
                            <div style="display: flex; margin-bottom: 3px; line-height: 1.3;">
                                <span style="font-weight: bold; width: 200px; flex-shrink: 0;">Nama</span>
                                <span style="margin-right: 10px;">:</span>
                                <span style="flex: 1;"><?php echo e($pengajuanSurat->user->nama_lengkap ?? '-'); ?></span>
                            </div>
                            <div style="display: flex; margin-bottom: 3px; line-height: 1.3;">
                                <span style="font-weight: bold; width: 200px; flex-shrink: 0;">NIK</span>
                                <span style="margin-right: 10px;">:</span>
                                <span style="flex: 1;"><?php echo e($pengajuanSurat->user->nik ?? '-'); ?></span>
                            </div>
                            <div style="display: flex; margin-bottom: 3px; line-height: 1.3;">
                                <span style="font-weight: bold; width: 200px; flex-shrink: 0;">Tempat, Tgl Lahir</span>
                                <span style="margin-right: 10px;">:</span>
                                <span style="flex: 1;"><?php echo e($pengajuanSurat->user->tempat_lahir ?? '-'); ?>,
                                    <?php echo e($pengajuanSurat->user->tanggal_lahir ? \Carbon\Carbon::parse($pengajuanSurat->user->tanggal_lahir)->format('d F Y') : '-'); ?></span>
                            </div>
                            <div style="display: flex; margin-bottom: 3px; line-height: 1.3;">
                                <span style="font-weight: bold; width: 200px; flex-shrink: 0;">Alamat</span>
                                <span style="margin-right: 10px;">:</span>
                                <span style="flex: 1;"><?php echo e($pengajuanSurat->user->alamat ?? '-'); ?> RT
                                    <?php echo e($pengajuanSurat->user->rt ?? '-'); ?> RW
                                    <?php echo e($pengajuanSurat->user->rw ?? '-'); ?></span>
                            </div>
                            <div style="display: flex; margin-bottom: 3px; line-height: 1.3;">
                                <span style="font-weight: bold; width: 200px; flex-shrink: 0;">No. Telepon</span>
                                <span style="margin-right: 10px;">:</span>
                                <span style="flex: 1;"><?php echo e($pengajuanSurat->user->no_telepon ?? '-'); ?></span>
                            </div>
                        </div>

                        <p style="margin-bottom: 14px;">Dengan penuh tanggung jawab, kami nyatakan bahwa data tersebut
                            di atas adalah benar adanya.</p>
                            ...
                            <div style="margin-bottom: 12px;">
                                <?php $__currentLoopData = $textFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fieldName => $fieldConfig): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php if($fieldValue !== null && $fieldValue !== ''): ?>
                                        <div style="display: flex; margin-bottom: 3px; line-height: 1.3; font-size: 16px;">
                                            <span
                                                style="font-weight: bold; width: 200px; flex-shrink: 0;"><?php echo e($fieldConfig['label']); ?></span>
                                            <span style="margin-right: 10px;">:</span>
                                            <div style="flex: 1;">
                                                <?php if($isTextarea): ?>
                        ...
                        <?php if($pengajuanSurat->keperluan): ?>
                            <div style="margin-bottom: 12px; font-size: 16px;">
                                <div style="display: flex; margin-bottom: 3px; line-height: 1.3;">
                                    <span style="font-weight: bold; width: 200px; flex-shrink: 0;">Keperluan</span>
                                    <span style="margin-right: 10px;">:</span>
                                    <span style="flex: 1;"><?php echo e($pengajuanSurat->keperluan); ?></span>
                                </div>
                                <?php if($pengajuanSurat->keterangan_tambahan): ?>
                                    <div style="display: flex; margin-bottom: 3px; line-height: 1.3;">
                                        <span style="font-weight: bold; width: 200px; flex-shrink: 0;">Keterangan</span>
                                        <span style="margin-right: 10px;">:</span>
                                        <span style="flex: 1;"><?php echo e($pengajuanSurat->keterangan_tambahan); ?></span>
                                    </div>
                                <?php endif; ?>
                            </div>
                        <?php endif; ?>
                    ...
                    <div style="margin-top: 15px; margin-bottom: 0;">
                        <div style="display: flex; justify-content: space-between;">
                            <div style="width: 49%; text-align: center;">
                                ...
                                <div
                                    style="margin: 0 0 8px 0; min-height: 120px; display: flex; align-items: flex-end; justify-content: center;">
                                </div>
                                <p style="margin: 0; font-size: 16px; font-weight: 500;">
                                    <?php echo e($pengajuanSurat->user->nama_lengkap ?? '-'); ?></p>
                            </div>
                            <div style="width: 49%; text-align: center;">
                                <p style="margin: 0 0 10px 0; font-size: 16px;">Mengetahui</p>
                                <div
                                    style="margin: 0 0 8px 0; min-height: 120px; display: flex; align-items: center; justify-content: center;">
                                    <?php if($qrCodeUrl): ?>
                                        <img src="<?php echo e($qrCodeUrl); ?>" alt="QR Code Verifikasi"
