            ...
            <div class="card main-card border-0">
                ...
                <div class="card-header-modern">
                    ...
                    <div class="header-right">
                        <a href="<?php echo e(route('pengaduan.create')); ?>" class="btn btn-create-new">
                        ...
                        <table class="table table-modern">
                            ...
                            <tbody>
                                ...
                                <tr class="table-row-modern">
                                    ...
                                    <td>
                                        <span class="judul-text"><?php echo e(Str::limit($pengaduan->judul, 40)); ?></span>
                                    </td>
                                    <td>
                                        ...
                                        <small class="text-muted d-block"><?php echo e($pengaduan->created_at->format('H:i')); ?></small>
                                    </td>
                                    <td class="col-status">
                                ...
                                <tr>
                                    <td colspan="7" class="p-0">
                                        <div class="empty-state">
                                            ...
                                            <a href="<?php echo e(route('pengaduan.create')); ?>" class="btn btn-create-empty">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC_\Documents\New folder\project-sekolah\resources\views/user/pengaduan/index.blade.php ENDPATH**/ ?>