    ...
    <body>
        ...
        <div class="auth-main">
            <div class="auth-wrapper v3">
                <div class="auth-form"
                    style="background-image: url(<?php echo e(asset('assets/images/my/ppdesa.jpeg')); ?>);background-size:cover;">
                    <div class="auth-header">
                        <a class="navbar-brand" href="/">
                            <img width="100" src="<?php echo e(asset('assets/images/my/icon-sda.png')); ?>" alt="logo">
                        </a>
                    </div>
...
<?php /**PATH C:\Users\PC_\Documents\New folder\project-sekolah\resources\views/layouts/auth.blade.php ENDPATH**/ ?>