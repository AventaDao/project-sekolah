            ...
            <div class="card-body">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="number" class="form-control" name="nik" placeholder="Masukkan NIK 16 digit"
                        value="<?php echo e(session('registered_nik')); ?>" autocomplete="off" maxlength="16" min="0" inputmode="numeric" required>
                </div>
                <div class="form-group mb-3">
                    <label for="password" class="form-label">Password</label>
                    <div class="input-group">
                        <?php if(session('registered_nik')): ?>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC_\Documents\New folder\project-sekolah\resources\views/auth/login.blade.php ENDPATH**/ ?>