                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <p class="text-muted mb-0">
                                <strong><?php echo e($pengajuans->where('status', 'Menunggu')->count()); ?></strong> pengajuan
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <p class="text-muted mb-0">
                                <strong><?php echo e($pengajuans->where('status', 'Diproses')->count()); ?></strong> pengajuan
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <p class="text-muted mb-0">
                                <strong><?php echo e($pengajuans->where('status', 'Selesai')->count()); ?></strong> pengajuan
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <p class="text-muted mb-0">
                                <strong><?php echo e($pengajuans->where('status', 'Ditolak')->count()); ?></strong> pengajuan
                            </p>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Documents\Laravel\UKK\appsdesa\resources\views/admin/pengajuan-surat/index.blade.php ENDPATH**/ ?>