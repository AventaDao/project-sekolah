    ...
    <div class="card my-5">
        <form method="POST" action="<?php echo e(route('forgot_password.send_link')); ?>">
            ...
            <div class="card-body">
                ...
                <?php if($errors->has('email') && old('email')): ?>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC_\Documents\New folder\project-sekolah\resources\views/auth/forgot-password/email.blade.php ENDPATH**/ ?>