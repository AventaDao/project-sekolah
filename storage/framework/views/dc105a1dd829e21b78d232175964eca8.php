                                    ...
                                    <div class="card-body position-relative text-center">
                                        <div class="chat-avtar d-inline-flex mx-auto mb-3 mt-3">
                                            <img class="rounded-circle img-fluid wid-70"
                                                ...
                                                alt="<?php echo e(auth()->user()->nama_lengkap); ?>"
                                                onerror="this.src='<?php echo e(asset('assets/images/avatar-default.png')); ?>'">
                                        </div>
                                        <h5 class="mb-0"><?php echo e(auth()->user()->nama_lengkap); ?></h5>
                                        <p class="text-muted text-sm"><?php echo e(auth()->user()->pekerjaan ?? 'N/A'); ?></p>
                                        <hr class="my-3">
                                        <div class="mb-3">
                                            <i class="ti ti-mail me-2"></i>
                                            <p class="mb-0 text-truncate"><small><?php echo e(auth()->user()->email); ?></small></p>
                                        </div>
                                        <div class="mb-3">
                                            <i class="ti ti-phone me-2"></i>
                                            <p class="mb-0"><?php echo e(auth()->user()->no_telepon ?? 'N/A'); ?></p>
                                        </div>
                                        <div class="mb-3">
                                            <i class="ti ti-id me-2"></i>
                                            <p class="mb-0"><?php echo e(auth()->user()->nik); ?></p>
                                        </div>
                                        <hr class="my-3">
                                        <div class="mb-3">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <p class="mb-0"><?php echo e(auth()->user()->nama_lengkap); ?></p>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <p class="mb-0"><?php echo e(auth()->user()->tempat_lahir ?? 'N/A'); ?></p>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <p class="mb-0">
                                                    ...
                                                    <?php elseif(auth()->user()->jenis_kelamin === 'P'): ?>
                                                        Perempuan
                                                    <?php else: ?>
                                                        <?php echo e(auth()->user()->jenis_kelamin ?? 'N/A'); ?>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <p class="mb-0"><?php echo e(auth()->user()->agama ?? 'N/A'); ?></p>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <p class="text-muted text-sm mb-1"><strong>Status Perkawinan</strong></p>
                                                <p class="mb-0"><?php echo e(auth()->user()->status_perkawinan ?? 'N/A'); ?></p>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <p class="text-muted text-sm mb-1"><strong>Kewarganegaraan</strong></p>
                                                <p class="mb-0"><?php echo e(auth()->user()->kewarganegaraan ?? 'N/A'); ?></p>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <p class="text-muted text-sm mb-1"><strong>Pekerjaan</strong></p>
                                                <p class="mb-0"><?php echo e(auth()->user()->pekerjaan ?? 'N/A'); ?></p>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <p class="text-muted text-sm mb-1"><strong>Pendidikan Terakhir</strong></p>
                                                <p class="mb-0"><?php echo e(auth()->user()->pendidikan_terakhir ?? 'N/A'); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <p class="mb-0"><?php echo e(auth()->user()->nama_ayah ?? 'N/A'); ?></p>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <p class="text-muted text-sm mb-1"><strong>Nama Ibu</strong></p>
                                                <p class="mb-0"><?php echo e(auth()->user()->nama_ibu ?? 'N/A'); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Documents\Laravel\UKK\appsdesa\resources\views/myprofile.blade.php ENDPATH**/ ?>