...
<div class="floating-pengaduan">
    ...
    <div class="pengaduan-menu" id="pengaduanMenu" style="display: none;">
        ...
        <div class="pengaduan-menu-body">
            ...
            <a href="<?php echo e(route('pengaduan.create')); ?>?kategori=Kendala Sistem Informasi Desa" class="pengaduan-item">
            ...
            <a href="<?php echo e(route('pengaduan.create')); ?>?kategori=Bantuan Sistem Informasi Desa" class="pengaduan-item">
            ...
            <a href="<?php echo e(route('pengaduan.create')); ?>?kategori=Laporan Kejadian Lapangan" class="pengaduan-item">
            ...
            <a href="<?php echo e(route('pengaduan.index')); ?>" class="btn btn-outline-primary btn-sm w-100">
...
<?php /**PATH C:\Users\PC_\Documents\New folder\project-sekolah\resources\views/component/floating-pengaduan.blade.php ENDPATH**/ ?>