            ...
            <div class="footer-wrapper container-fluid">
                <div class="row">
                    <div class="col-sm my-1">
                        <p class="m-0">Made by &#9829; <a
                                href="https://github.com/aventadao" target=""> Aventadao</a>.</p>
                    </div>
...
<?php if(Auth::check() && Auth::user()->role !== 'admin'): ?>
    <?php echo $__env->make('components.floating-pengaduan', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php endif; ?>
    </body>
    <!-- [Body] end -->

</html>
<?php /**PATH C:\LARAVEL12\inidesa\resources\views/layouts/dashboard.blade.php ENDPATH**/ ?>