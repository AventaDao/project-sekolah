...
<?php $__env->startSection('content'); ?>
    ...
    <header class="contact-hero"
        style="position: relative; padding: 100px 0; background: url('<?php echo e(asset('assets/images/my/gedung-sekolah.png')); ?>') no-repeat center center; background-size: cover;">
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\LARAVEL12\appdesa\resources\views/contact.blade.php ENDPATH**/ ?>