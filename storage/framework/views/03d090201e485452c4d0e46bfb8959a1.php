...
unset($__errorArgs, $__bag); ?>" required>
                                <option value="Menunggu" <?php echo e($pengaduan->status == 'Menunggu' ? 'selected' : ''); ?>>
                                    Menunggu
                                </option>
                                <option value="Diproses" <?php echo e($pengaduan->status == 'Diproses' ? 'selected' : ''); ?>>
                                    Diproses
                                </option>
                                <option value="Selesai" <?php echo e($pengaduan->status == 'Selesai' ? 'selected' : ''); ?>>
                                    Selesai
                                </option>
                                <option value="Ditolak" <?php echo e($pengaduan->status == 'Ditolak' ? 'selected' : ''); ?>>
                                    Ditolak
                                </option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="tanggapan_admin" class="form-control <?php $__errorArgs = ['tanggapan_admin'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                      rows="6" placeholder="Tulis tanggapan atau solusi untuk pengaduan ini..."><?php echo e(old('tanggapan_admin', $pengaduan->tanggapan_admin)); ?></textarea>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC_\Documents\New folder\project-sekolah\resources\views/admin/pengaduan/show.blade.php ENDPATH**/ ?>