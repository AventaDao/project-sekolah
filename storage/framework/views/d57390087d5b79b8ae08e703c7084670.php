        ...
        <?php if(session('verify_email')): ?>
            <div class="card-body">
                <div class="mb-4">
                    ...
                    <?php else: ?>
                        <div>
                            We`ve send you code on <?php echo e(session('verify_email')); ?>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC_\Documents\New folder\project-sekolah\resources\views/auth/verify-email.blade.php ENDPATH**/ ?>