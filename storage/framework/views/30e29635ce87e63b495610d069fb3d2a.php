...
<head>
    ...
    <title>Pengaduan Selesai - Sistem Informasi Desa</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="status-box">
                ...
                <div class="status-text">Pengaduan Selesai Ditangani</div>
                <div class="status-subtext">Terima kasih atas laporan Anda. Pengaduan Anda telah selesai kami tangani.</div>
            </div>
            ...
            <div class="details-section">
                ...
                <div class="detail-item">
                    ...
                    <span class="detail-value"><?php echo e($pengaduan->tanggal_tanggapan?->format('d F Y H:i') ?? '-'); ?> WIB</span>
                </div>
            ...
            <div class="button-container">
                <p style="margin-bottom: 15px; font-size: 14px; color: #555;">
                    Silakan klik tombol di bawah untuk melihat detail lengkap tanggapan kami:
                </p>
            ...
            <p style="font-size: 13px; color: #999; line-height: 1.6; margin-top: 20px;">
                Terima kasih atas partisipasi Anda dalam membantu kami meningkatkan pelayanan desa. 
                Jika Anda memiliki pengaduan lain, jangan ragu untuk melaporkannya.
            </p>
        </div>
...
<?php /**PATH C:\project-sekolah\resources\views/emails/pengaduan-selesai.blade.php ENDPATH**/ ?>