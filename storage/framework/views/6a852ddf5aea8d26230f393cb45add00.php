<?php $__env->startSection('title', 'Tambah Berita Desa'); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                           value="<?php echo e(old('judul')); ?>" required placeholder="Masukkan judul berita">
...
unset($__errorArgs, $__bag); ?>" 
                                              rows="10" required placeholder="Tulis isi berita di sini..."><?php echo e(old('isi')); ?></textarea>
                                    <?php $__errorArgs = ['isi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" required>
                                        ...
                                        <option value="publish" <?php echo e(old('status', 'publish') == 'publish' ? 'selected' : ''); ?>>Publish</option>
                                    </select>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC_\Documents\New folder\project-sekolah\resources\views/admin/berita/create.blade.php ENDPATH**/ ?>