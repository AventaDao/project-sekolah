                        ...
                        <div class="d-flex align-items-center position-relative" style="z-index: 1;">
                            ...
                            <div class="flex-grow-1 ms-3">
                                ...
                                <p class="stat-value mb-0">
                                    {{ \App\Models\Penduduk::where('status_hidup', 'Hidup')->count() }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center position-relative" style="z-index: 1;">
                            ...
                            <div class="flex-grow-1 ms-3">
                                ...
                                <p class="stat-value mb-0">
                                    {{ \App\Models\Penduduk::where('status_hidup', 'Hidup')->whereNotIn('nik', \App\Models\User::pluck('nik'))->count() }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center position-relative" style="z-index: 1;">
                            ...
                            <div class="flex-grow-1 ms-3">
                                ...
                                <p class="stat-value mb-0">
                                    {{ \App\Models\Penduduk::where('status_hidup', 'Meninggal')->count() }}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card main-card border-0">
                    ...
                    <div class="card-body">
                                ...
                                <tbody>
                                    @forelse($penduduks as $key => $penduduk)
                                        <tr class="table-row-modern">
                                            <td class="col-num">
                                                <span class="row-number">{{ $penduduks->firstItem() + $key }}</span>
                                            </td>
                                            <td>
                                                <strong class="nik-text">{{ $penduduk->nik }}</strong>
                                            </td>
                                            <td>
                                                <span class="nama-text">{{ $penduduk->nama_lengkap }}</span>
                                                @php
                                            ...
                                            <td>
                                                <span class="jk-badge">{{ $penduduk->jenis_kelamin }}</span>
                                            </td>
                                            <td>
                                                <span class="ttl-text">{{ $penduduk->tempat_lahir }},
                                                    {{ $penduduk->tanggal_lahir->format('d-m-Y') }}</span>
                                            </td>
                                            <td>
                                                <span class="alamat-text">{{ Str::limit($penduduk->alamat, 30) }}</span>
                                            </td>
                                            <td class="col-action">
                        ...
                        <div class="pagination-wrapper">
                            {{ $penduduks->links('vendor.pagination.modern') }}
                        </div>
                    </div>
                </div>
            </div>
