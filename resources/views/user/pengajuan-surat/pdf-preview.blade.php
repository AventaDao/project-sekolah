                ...
                <div id="letterContent"
                    ...
                    <div
                        ...
                        <div style="flex-shrink: 0; margin-right: 15px;">
                            <img src="{{ asset('assets/images/my/icon-sda.png') }}" alt="Logo Sidoarjo"
                    ...
                    <div style="margin-bottom: 12px; line-height: 1.5; font-size: 16px;">
                        ...
                        <div style="margin-bottom: 18px; font-size: 16px;">
                            <div style="display: flex; margin-bottom: 3px; line-height: 1.3;">
                                ...
                                <span style="flex: 1;">{{ $pengajuanSurat->user->nama_lengkap ?? '-' }}</span>
                            </div>
                            <div style="display: flex; margin-bottom: 3px; line-height: 1.3;">
                                <span style="font-weight: bold; width: 200px; flex-shrink: 0;">NIK</span>
                                <span style="margin-right: 10px;">:</span>
                                <span style="flex: 1;">{{ $pengajuanSurat->user->nik ?? '-' }}</span>
                            </div>
                            <div style="display: flex; margin-bottom: 3px; line-height: 1.3;">
                                <span style="font-weight: bold; width: 200px; flex-shrink: 0;">Tempat, Tgl Lahir</span>
                                <span style="margin-right: 10px;">:</span>
                                <span style="flex: 1;">{{ $pengajuanSurat->user->tempat_lahir ?? '-' }},
                                    {{ $pengajuanSurat->user->tanggal_lahir ? \Carbon\Carbon::parse($pengajuanSurat->user->tanggal_lahir)->format('d F Y') : '-' }}</span>
                            </div>
                            <div style="display: flex; margin-bottom: 3px; line-height: 1.3;">
                                <span style="font-weight: bold; width: 200px; flex-shrink: 0;">Alamat</span>
                                <span style="margin-right: 10px;">:</span>
                                <span style="flex: 1;">{{ $pengajuanSurat->user->alamat ?? '-' }} RT
                                    {{ $pengajuanSurat->user->rt ?? '-' }} RW
                                    {{ $pengajuanSurat->user->rw ?? '-' }}</span>
                            </div>
                            <div style="display: flex; margin-bottom: 3px; line-height: 1.3;">
                                <span style="font-weight: bold; width: 200px; flex-shrink: 0;">No. Telepon</span>
                                <span style="margin-right: 10px;">:</span>
                                <span style="flex: 1;">{{ $pengajuanSurat->user->no_telepon ?? '-' }}</span>
                            </div>
                        </div>
                                ...
                                @foreach($textFields as $fieldName => $fieldConfig)
                                    ...
                                    @if($fieldValue !== null && $fieldValue !== '')
                                        <div style="display: flex; margin-bottom: 3px; line-height: 1.3; font-size: 16px;">
                                            <span
                                                style="font-weight: bold; width: 200px; flex-shrink: 0;">{{ $fieldConfig['label'] }}</span>
                                            <span style="margin-right: 10px;">:</span>
                                            <div style="flex: 1;">
                                                @if($isTextarea)
                        ...
                        <div style="display: flex; justify-content: space-between;">
                            <div style="width: 49%; text-align: center;">
                                ...
                                <p style="margin: 0; font-size: 16px; font-weight: 500;">
                                    {{ $pengajuanSurat->user->nama_lengkap ?? '-' }}</p>
                            </div>
                            <div style="width: 49%; text-align: center;">
