...
@section('title', 'Verifikasi Surat - ' . $pengajuanSurat->jenis_surat)
                ...
                <div class="card shadow-sm">
                    <div class="card-body p-5">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-4">
                                        ...
                                        <p class="fw-bold">{{ $pengajuanSurat->jenis_surat }}</p>
                                    </div>
                                    <div class="col-sm-4">
                                        <small class="text-muted">Nomor Surat</small>
                                        <p class="fw-bold">{{ $pengajuanSurat->nomor_pengajuan }}</p>
                                    </div>
                                    <div class="col-sm-4">
                                        <small class="text-muted">Status</small>
                                        <p><span class="badge {{ $pengajuanSurat->status_badge }}">{{ $pengajuanSurat->status }}</span></p>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-6">
                                        ...
                                        <p class="fw-bold">{{ $pengajuanSurat->user->nama_lengkap ?? '-' }}</p>
                                    </div>
                                    <div class="col-sm-6">
                                        <small class="text-muted">NIK</small>
                                        <p class="fw-bold">{{ $pengajuanSurat->user->nik ?? '-' }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <p>{{ $pengajuanSurat->created_at->format('d F Y H:i') }} WIB</p>
                                    </div>
                                    @if($pengajuanSurat->tanggal_selesai)
                                    <div class="col-sm-6">
                                        <small class="text-muted">Tanggal Penyelesaian</small>
                                        <p>{{ $pengajuanSurat->tanggal_selesai->format('d F Y H:i') }} WIB</p>
                                    </div>
                                    @endif
                                </div>
                            </div>
                        ...
                        <div class="text-center text-muted small">
                            <p class="mb-1">Kode Verifikasi: <code>{{ $pengajuanSurat->nomor_pengajuan }}</code></p>
                            <p>Diverifikasi pada: {{ now()->format('d F Y H:i') }} WIB</p>
                        </div>
