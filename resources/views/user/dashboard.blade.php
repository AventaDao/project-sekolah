            ...
            <div class="card-body position-relative z-1">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <h3 class="mb-0 counter stat-number" data-count="{{ $stats['my_pengajuan_menunggu'] + $stats['my_pengajuan_diproses'] + $stats['my_pengajuan_selesai'] }}">0</h3>
            ...
            <div class="card-body position-relative z-1">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <h3 class="mb-0 counter stat-number" data-count="{{ $stats['my_pengaduan_menunggu'] + $stats['my_pengaduan_selesai'] }}">0</h3>
                        <small class="stat-badge">
            ...
            <div class="card-body position-relative z-1">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <h3 class="mb-0 counter stat-number" data-count="{{ $stats['surat_disetujui'] }}">0</h3>
                        <small class="stat-badge">
    ...
    <div class="col-12 mt-4">
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                <div class="row g-4">
                    <div class="col-md-4">
                        <a href="{{ route('pengajuan-surat.create') }}" class="quick-action-card quick-action-ajukan">
                    ...
                    <div class="col-md-4">
                        <a href="{{ route('pengajuan-surat.index') }}" class="quick-action-card quick-action-riwayat">
                            <div class="quick-action-content">
                                <div class="quick-action-icon-wrapper">
                    ...
                    <div class="col-md-4">
                        <a href="{{ route('pengaduan.index') }}" class="quick-action-card quick-action-pengaduan">
                            <div class="quick-action-content">
                                <div class="quick-action-icon-wrapper">
