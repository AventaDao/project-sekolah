...
<li class="pc-item sidebar-menu-item {{ request()->is('pengajuan-surat*') ? 'active' : '' }}">
    <a href="{{ route('pengajuan-surat.index') }}" class="pc-link sidebar-link">
...
<li class="pc-item sidebar-menu-item sidebar-collapsible {{ request()->is('pengaduan*') ? 'active' : '' }}">
    ...
    <ul class="pc-submenu sidebar-submenu" id="pengaduanSubmenu" style="display: none; list-style: none; padding-left: 0;">
        <!-- Kendala Sistem -->
        <li class="pc-item sidebar-submenu-item {{ request()->is('pengaduan/create*') && request()->query('kategori') == 'Kendala Sistem Informasi Desa' ? 'active' : '' }}">
            <a href="{{ route('pengaduan.create') }}?kategori={{ urlencode('Kendala Sistem Informasi Desa') }}" class="pc-link sidebar-submenu-link">
        ...
        <!-- Bantuan Sistem -->
        <li class="pc-item sidebar-submenu-item {{ request()->is('pengaduan/create*') && request()->query('kategori') == 'Bantuan Sistem Informasi Desa' ? 'active' : '' }}">
            <a href="{{ route('pengaduan.create') }}?kategori={{ urlencode('Bantuan Sistem Informasi Desa') }}" class="pc-link sidebar-submenu-link">
                <span class="pc-micon sidebar-submenu-icon">
        ...
        <!-- Laporan Kejadian -->
        <li class="pc-item sidebar-submenu-item {{ request()->is('pengaduan/create*') && request()->query('kategori') == 'Laporan Kejadian Lapangan' ? 'active' : '' }}">
            <a href="{{ route('pengaduan.create') }}?kategori={{ urlencode('Laporan Kejadian Lapangan') }}" class="pc-link sidebar-submenu-link">
                <span class="pc-micon sidebar-submenu-icon">
        ...
        <!-- Pengaduan Saya -->
        <li class="pc-item sidebar-submenu-item {{ request()->is('pengaduan/index*') || request()->is('pengaduan') ? 'active' : '' }}">
            <a href="{{ route('pengaduan.index') }}" class="pc-link sidebar-submenu-link">
                <span class="pc-micon sidebar-submenu-icon">
...
<!-- <li class="pc-item sidebar-menu-item {{ request()->is('activities*') ? 'active' : '' }}">
    <a href="{{ route('activities.index') }}" class="pc-link sidebar-link">
        <span class="pc-micon sidebar-icon">
