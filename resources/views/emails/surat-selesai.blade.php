    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="details-section">
                ...
                <div class="detail-item">
                    ...
                    <span class="detail-value">
                        <span class="badge">{{ $pengajuanSurat->nomor_pengajuan }}</span>
                    </span>
                </div>

                <div class="detail-item">
                    <span class="detail-label">Jenis Surat:</span>
                    <span class="detail-value">{{ $pengajuanSurat->jenis_surat }}</span>
                </div>

                <div class="detail-item">
                    <span class="detail-label">Tanggal Selesai:</span>
                    <span class="detail-value">{{ $pengajuanSurat->tanggal_selesai?->format('d F Y H:i') ?? '-' }} WIB</span>
                </div>
            ...
            <div class="button-container">
                ...
                <a href="{{ route('pengajuan-surat.show', $pengajuanSurat->id) }}" class="cta-button">
                    Lihat & Unduh Surat
                </a>
            </div>
