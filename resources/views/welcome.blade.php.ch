...
@section('content')
                ...
                <div class="col-lg-10 col-xl-8 text-center">
                    ...
                    <div class="badge-container wow fadeInDown" data-wow-delay="0.1s">
                        <span class="animated-badge">
                            <i class="ti ti-snowflake me-2"></i>
                    ...
                    <h1 class="hero-title mt-4 mb-4 wow fadeInUp" data-wow-delay="0.2s">
                        Selamat Datang di
                        <br>
                        <span class="text-gradient-christmas">Sistem Informasi Desa</span>
                    </h1>
                    ...
                    <h5 class="hero-subtitle mb-4 wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        Mari berkontribusi dalam memajukan desa kita bersama di musim Natal ini 🎅
                    </h5>
                    
                    <div class="my-5 wow fadeInUp" data-wow-delay="0.6s">
                        <a href="{{ route('login') }}"
                            class="btn btn-christmas btn-lg btn-animated d-inline-flex align-items-center me-3 mb-3 mb-md-0">
                            Masuk Sistem 
    ...
    <!-- [ Stats Counter ] start -->
    <section class="stats-section christmas-stats">
        <div class="container">
            <div class="row g-4">
    ...
    <!-- [ Fitur Utama ] start -->
    <section id="fitur" class="features-section christmas-features">
        <div class="container title">
            <div class="row justify-content-center text-center wow fadeInUp" data-wow-delay="0.2s">
                <div class="col-md-10 col-xl-6">
                    <span class="section-badge christmas-badge">🎄 Fitur Unggulan</span>
                    <h2 class="section-title">Mengapa Memilih Sistem Ini?</h2>
                    <p class="section-subtitle">Sistem Informasi Desa membantu pemerintah dan masyarakat mengelola data kependudukan, pelayanan publik, serta laporan desa dengan mudah dan transparan.</p>
                </div>
            </div>
        </div>
    ...
    <section class="process-section christmas-process" id="alur">
        <div class="container title">
            <div class="row justify-content-center text-center wow fadeInUp" data-wow-delay="0.2s">
                <div class="col-md-10 col-xl-6">
                    <span class="section-badge christmas-badge">🎅 Langkah Mudah</span>
    ...
    <!-- [ CTA ] start -->
    <section class="cta-section christmas-cta"
        ...
        <div class="cta-overlay-christmas"></div>
        <div class="container" style="position: relative; z-index: 2;">
            <div class="row justify-content-center">
                <div class="col-md-8 text-center">
                    <h2 class="cta-title wow fadeInUp" data-wow-delay="0.2s">
                        Tingkatkan Layanan Desa dengan
                        <span class="text-gradient-christmas">Sistem Informasi Digital</span>
                    </h2>
    ...
    <style>
        ...
        .hero-overlay {
            ...
            right: 0;
            bottom: 0;
            background: linear-gradient(135deg, rgba(200, 16, 46, 0.7) 0%, rgba(22, 100, 22, 0.85) 100%) !important;
            animation: gradientShift 10s ease infinite;
        }

        .text-gradient-christmas {
            background: linear-gradient(135deg, #00d84f 0%, #ffeb3b 50%, #ff6b6b 100%);
        ...
        /* Button Christmas */
        .btn-christmas {
            background: linear-gradient(135deg, #c81030 0%, #f44336 100%) !important;
            border: none;
            color: white;
            font-weight: 600;
        ...
        .btn-christmas:hover {
            background: linear-gradient(135deg, #a00825 0%, #d32f2f 100%) !important;
            transform: translateY(-3px);
            box-shadow: 0 10px 30px rgba(200, 16, 46, 0.4);
            color: white;
        }

        /* Christmas Stats Section */
        .christmas-stats {
            background: linear-gradient(135deg, #c81030 0%, #22aa22 100%) !important;
        }

        .christmas-stats .stat-card {
        ...
        .christmas-stats .stat-icon {
            background: linear-gradient(135deg, #c81030 0%, #ffeb3b 100%) !important;
        }

        .christmas-stats .stat-number,
        .christmas-stats .stat-label {
            color: #2c3e50;
        }
        ...
        .christmas-features {
            background: linear-gradient(180deg, #f5f5f5 0%, #fff9e6 100%) !important;
        }

        .christmas-features .feature-card {
            border-top: 5px solid #c81030;
            box-shadow: 0 10px 40px rgba(200, 16, 46, 0.1);
        }

        .christmas-features .feature-card::before {
            background: linear-gradient(90deg, #c81030 0%, #22aa22 100%) !important;
        }

        .christmas-features .feature-icon {
            background: linear-gradient(135deg, #c81030 0%, #f44336 100%) !important;
        }

        /* Christmas Process Section */
        .christmas-process {
            background: linear-gradient(180deg, #fff9e6 0%, #f5f5f5 100%) !important;
        }

        .christmas-process .process-card {
            border: 3px solid #c81030;
            background: white;
        }

        .christmas-process .process-icon {
            background: linear-gradient(135deg, #22aa22 0%, #66bb6a 100%) !important;
        }

        .christmas-process .process-line {
            background: linear-gradient(90deg, #c81030 0%, #22aa22 100%) !important;
        }

        .christmas-process .process-line::after {
            border-left-color: #22aa22 !important;
        }

        /* Christmas CTA Section */
        .cta-overlay-christmas {
            position: absolute;
            top: 0;
            left: 0;
            right: 0;
            bottom: 0;
            background: linear-gradient(135deg, rgba(200, 16, 46, 0.95) 0%, rgba(34, 170, 34, 0.95) 100%);
        }
    ...
    <script src="{{ asset('assets/js/christmas.js') }}"></script>
